...
describe("ZinnionProvider", () => {
  ...
  it(
    "should throw Exception if the `url` " +
  ...
  it("should provide `zinnion` context", () => {
    ...
    expect(wrapper.getChildContext().zinnion.constructor.name).toBe(
      "ZinnionManager"
    );
    expect(ZinnionProvider.childContextTypes.zinnion).toBe(
  ...
  it("should have children proptype required", () => {
    expect(ZinnionProvider.propTypes.children).toBe(
